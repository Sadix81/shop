            ...
            <div class="card-body card-block">
                <form action={{route('product.store')}} method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        <div class="col-12">
                            <input type="text" id="name" name="name" placeholder="products name" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-12 ">
                            <input type="number" id="count" name="count" placeholder="products count" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-12">
                            <div class="input-group">
                                <input type="number" name="is_sale" placeholder="0.00" class="form-control">
                        ...
                        <div class="col-12">
                            <select  name="category_id" class="form-select form-control">
                                @foreach($categories as $category)
                                    <option value="#" selected hidden>select products category</option>
