    ...
    <div class="container">
        ...
        <div class="services border-bottom py-4 mb-4">
            <div class="service-container">
                <a href="#" class="service">
                            <span class="service-icon">
                                <img src="{{asset('images/services/01.svg')}}" alt="">
                            </span>
            ...
            <div class="service-container">
                <a href="#" class="service">
                            <span class="service-icon">
                                <img src="{{asset('images/services/02.svg')}}" alt="">
                            </span>
            ...
            <div class="service-container">
                <a href="#" class="service">
                            <span class="service-icon">
                                <img src="{{asset('images/services/03.svg')}}" alt="">
                            </span>
            ...
            <div class="service-container">
                <a href="#" class="service">
                            <span class="service-icon">
                                <img src="{{asset('images/services/04.svg')}}" alt="">
                            </span>
            ...
            <div class="service-container">
                <a href="#" class="service">
                            <span class="service-icon">
                                <img src="{{asset('images/services/05.svg')}}" alt="">
                            </span>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="trust-symbol">
                    <a href="#">
                        <img src="{{asset('images/symbol/01.png')}}" alt="">
                    </a>
                    <a href="#">
                        <img src="{{asset('images/symbol/02.png')}}" alt="">
                    </a>
                    <a href="#">
                        <img src="{{asset('images/symbol/03.png')}}" alt="">
                    </a>
                </div>
            </div>
        </div>
