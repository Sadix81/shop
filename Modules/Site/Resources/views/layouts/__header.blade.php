<header class="page-header d-md-block d-none">
    ...
    <div class="alert banner-container alert-dismissible fade show" role="alert">
        <a href="#" class="banner-placement rounded-0"
           style="background-image: url({{asset('images/banner/017.jpg')}});height: 60px;"></a>
                ...
                <div class="d-flex align-items-center flex-grow-1 pe-3">
                    <div class="logo-container logo-box me-3">
                        <a href="index-1.html" class="logo">
                            <img src="{{asset('images/logo.svg')}}" width="120" alt="">
                                        ...
                                        <div class="profile-detail">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="profile-info">
                                                    ...
                                                    <div class="text-muted fs-7 fw-bold">33333333333</div>
                                                </div>
                                            </div>
                                            <div class="user-options">
                                                <ul>
                                                    <li>
                                                        ...
                                                        <span class="detail">
                                                            <span class="d-block">0
                                                                <span class="currency fs-7 fw-bold">تومان</span>
                                                            </span>
                                                            <a href="#" class="link border-bottom-0 text-info fs-7 fw-bold">افزایشموجودی
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="detail">
                                                            <span class="d-block">0
                                                                <span class="score text-muted fs-7">امتیاز</span>
                                                            </span>
                                                        </span>
                                                    </li>
                                                </ul>
...
{{--                          @endauth--}}
                    ...
                    <div class="user-option">
                        <a href="{{route('favourite.product.show')}}" class="user-option-btn user-option-btn--account">
                            ...
                            <div class="mini-cart-products do-simplebar">
                                <div class="mini-cart-product">
                                    <div class="mini-cart-product-thumbnail">
                                        <a href="#"><img src="{{asset('images/products/01.jpg')}}" alt=""></a>
                                    </div>
                                ...
                                <div class="mini-cart-product">
                                    <div class="mini-cart-product-thumbnail">
                                        <a href="#"><img src="{{asset('images/products/02.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="mini-cart-product-detail">
                                ...
                                <div class="mini-cart-product">
                                    <div class="mini-cart-product-thumbnail">
                                        <a href="#"><img src="{{asset('images/products/05.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="mini-cart-product-detail">
                                        <div class="mini-cart-product-brand"><a href="#">apple</a></div>
                                        <div class="mini-cart-product-title">
                                ...
                                <div class="mini-cart-product">
                                    <div class="mini-cart-product-thumbnail">
                                        <a href="#"><img src="{{asset('images/products/07.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="mini-cart-product-detail">
...
{{--                                <li class="mega-menu-category show" value="{{$category->id}}">--}}
...
{{--                            @endforeach--}}
                ...
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('site.')}}">خانه</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('site.products')}}">محصولات</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">وبلاگ</a>
                    </li>
