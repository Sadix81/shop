        ...
        <div class="container">
            <div class="row mb-3 d-sm-block d-none">
                <div class="col-12">
                    ...
                    <div class="banner-img">
                        <a href="#"><img src="{{asset('images/banner/025.gif')}}" alt="banner"></a>
                    </div>
                    <!-- end of banner -->
                </div>
            </div>
                            ...
                            <div class="swiper-slide main-swiper-slide">
                                <a href="#"
                                   style="background-image: url(images/slider/main/01.jpg);">
                                    <img src="{{asset('images/slider/main/01.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide main-swiper-slide">
                                <a href="#"
                                   style="background-image: url({{asset('images/slider/main/02.jpg')}});">
                                    <img src="{{asset('images/slider/main/02.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide main-swiper-slide">
                                <a href="#"
                                   style="background-image: url({{asset('images/slider/main/03.jpg')}});">
                                    <img src="{{asset('images/slider/main/03.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="swiper-slide main-swiper-slide">
                                <a href="#"
                                   style="background-image: url({{asset('images/slider/main/04.jpg')}});">
                                    <img src="{{asset('images/slider/main/04.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-6 mb-lg-3">
                            ...
                            <div class="banner-img banner-side-main-slider bg-position-right">
                                <a href="#"
                                   style="background-image: url({{asset('images/banner/026.jpg')}});height:220px;">
                                    <img src="{{asset('images/banner/026.jpg')}}" alt="">
                                </a>
                            </div>
                            <!-- end of banner -->
                        </div>
                        <div class="col-lg-12 col-6">
                            ...
                            <div class="banner-img banner-side-main-slider bg-position-right">
                                <a href="#"
                                   style="background-image: url({{asset('images/banner/027.jpg')}});height:220px;">
                                    <img src="{{asset('images/banner/027.jpg')}}" alt="">
                                </a>
                            </div>
                            <!-- end of banner -->
                        </div>
            ...
            <div class="row mb-5">
                <div class="col-md-6 mb-lg-0 mb-3">
                    ...
                    <div class="banner-img">
                        <a href="#">
                            <img src="{{asset('images/banner/018.jpg')}}" alt="">
                        </a>
                    </div>
                    <!-- end of banner -->
                </div>
                <div class="col-md-6 mb-lg-0 mb-3">
                    ...
                    <div class="banner-img">
                        <a href="#">
                            <img src="{{asset('images/banner/019.jpg')}}" alt="">
                        </a>
                    </div>
                    <!-- end of banner -->
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 d-lg-block d-none">
                                <div class="specials-container">
                                    <img src="{{asset('images/theme/specials.png')}}" class="img-fluid" alt="">
                                ...
                                <div class="swiper product-specials-swiper-slider mb-3 pb-5">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide d-lg-none d-sm-block d-none">
                                            <div class="specials-container">
                                                <img src="{{asset('images/theme/specials.png')}}"
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="product-card-body">
                                                    <h2 class="product-title">
                                                        <a href="{{route('site.show' , $product->id)}}">{{$product->name}}</a>
                                                    </h2>
                                                    <div class="product-variant"><span class="color" style="background-color: #d4d4d4;"></span>
                                                    ...
                                                    <div class="product-price fa-num">
                                                        @if (!empty($product->is_sale))
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <span class="discount ms-2">${{$product->is_sale}}</span>
                                                            </div>
                                                            <span class="price-now">{{$product->off}} <span class="currency">تومان</span></span>
                                                            @else
                                                                <span class="price-now">{{$product->price}} <span class="currency">تومان</span></span>
                                                        @endif
                                                    </div>
                                                </div>
                                                                ...
                                                                <li>
                                                                    <form action="{{route('favourite.product.select' , $product->id)}}" method="post">
                                                                        ...
                                                                        <button type="submit" class="border-0 bg-transparent">
                                                                            <a href="" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="افزودن به علاقمندی" aria-label="افزودن به علاقمندی">
            ...
            <div class="row mb-5">
                <div class="col-md-3 col-6 mb-lg-0 mb-3">
                    ...
                    <div class="banner-img">
                        <a href="#">
                            <img src="{{asset('images/banner/020.jpg')}}" alt="">
                        </a>
                    </div>
                    <!-- end of banner -->
                </div>
                <div class="col-md-3 col-6 mb-lg-0 mb-3">
                    ...
                    <div class="banner-img">
                        <a href="#">
                            <img src="{{asset('images/banner/021.jpg')}}" alt="">
                        </a>
                    </div>
                    <!-- end of banner -->
                </div>
                <div class="col-md-3 col-6 mb-lg-0 mb-3">
                    ...
                    <div class="banner-img">
                        <a href="#">
                            <img src="{{asset('images/banner/022.jpg')}}" alt="">
                        </a>
                    </div>
                    <!-- end of banner -->
                </div>
                <div class="col-md-3 col-6 mb-lg-0 mb-3">
                    ...
                    <div class="banner-img">
                        <a href="#">
                            <img src="{{asset('images/banner/023.jpg')}}" alt="">
                        </a>
                    </div>
                    <!-- end of banner -->
                </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    <div class="product-thumbnail">
                                        <a href="#">
                                            <img src="{{asset('images/products/01.jpg')}}" alt="product title">
                                        </a>
                                    </div>
                                    <div class="product-card-body">
                                        <h2 class="product-title">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    <div class="product-thumbnail">
                                        <a href="#">
                                            <img src="{{asset('images/products/02.jpg')}}" alt="product title">
                                        </a>
                                    </div>
                                    <div class="product-card-body">
                                        <h2 class="product-title">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    <div class="product-thumbnail">
                                        <a href="#">
                                            <img src="{{asset('images/products/03.jpg')}}" alt="product title">
                                        </a>
                                    </div>
                                    <div class="product-card-body">
                                        <h2 class="product-title">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    <div class="product-thumbnail">
                                        <a href="#">
                                            <img src="{{asset('images/products/04.jpg')}}" alt="product title">
                                        </a>
                                    </div>
                                    <div class="product-card-body">
                                        <h2 class="product-title">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    <div class="product-thumbnail">
                                        <a href="#">
                                            <img src="{{asset('images/products/05.jpg')}}" alt="product title">
                                        </a>
                                    </div>
                                    <div class="product-card-body">
                                        <h2 class="product-title">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    <div class="product-thumbnail">
                                        <a href="#">
                                            <img src="{{asset('images/products/06.jpg')}}" alt="product title">
                                        </a>
                                    </div>
                                    <div class="product-card-body">
                                        <h2 class="product-title">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    <div class="product-thumbnail">
                                        <a href="#">
                                            <img src="{{asset('images/products/07.jpg')}}" alt="product title">
                                        </a>
                                    </div>
                                    <div class="product-card-body">
                                        <h2 class="product-title">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    <div class="product-thumbnail">
                                        <a href="#">
                                            <img src="{{asset('images/products/08.jpg')}}" alt="product title">
                                        </a>
                                    </div>
                                    <div class="product-card-body">
                                        <h2 class="product-title">
